      ...
      const demoProfiles = [
        {
          ...
          bio: "Ceramics hobbyist who loves neighborhood cafés, rainy walks, and finding the best local bookstores.",
          tagline: "Making room for small adventures",
          lookingFor: "Someone thoughtful who enjoys creative weekends and easy conversation.",
          interests: ["ceramics", "coffee", "bookstores", "walking", "indie films"],
          photos: [],
          height: "5'4\"",
          bodyType: "average",
        ...
        },
        {
          ...
          gender: "man",
          location: "Denver, CO",
          bio: "Weekend climber, home cook, and live-music regular who is always planning the next mountain day.",
          tagline: "Good views and better company",
          lookingFor: "An upbeat partner for concerts, trail days, and trying new recipes.",
          interests: ["climbing", "cooking", "concerts", "camping", "skiing"],
          photos: [],
          height: "5'11\"",
          bodyType: "athletic",
        ...
        },
        {
          ...
          gender: "woman",
          location: "Boston, MA",
          bio: "Museum fan and pastry experimenter who appreciates clever humor, old neighborhoods, and long Sunday brunches.",
          tagline: "Curious about almost everything",
          lookingFor: "A kind, witty person who likes culture, food, and unhurried weekends.",
          interests: ["museums", "baking", "history", "brunch", "theater"],
          photos: [],
          height: "5'6\"",
          bodyType: "slim",
        ...
        },
        {
          ...
          bio: "Community-minded architect who spends free time surfing, sketching, and searching for excellent tacos.",
          tagline: "Designing a life with balance",
          lookingFor: "Someone grounded who enjoys the coast, community, and spontaneous plans.",
          interests: ["architecture", "surfing", "sketching", "tacos", "volunteering"],
          photos: [],
          height: "6'0\"",
          bodyType: "fit",
        ...
        },
        {
          ...
          bio: "Songwriter and plant collector who enjoys porch dinners, record shops, and road trips with a great playlist.",
          tagline: "Always listening for a good story",
          lookingFor: "A warm, curious partner who values creativity and honest communication.",
          interests: ["songwriting", "plants", "vinyl", "road trips", "gardening"],
          photos: [],
          height: "5'8\"",
          bodyType: "average",
        ...
        },
        {
          ...
          bio: "Public radio devotee, cyclist, and enthusiastic soup maker who never misses a neighborhood festival.",
          tagline: "Warm meals, cold rides, good people",
          lookingFor: "Someone sincere who enjoys community events and a healthy dose of humor.",
          interests: ["cycling", "radio", "cooking", "festivals", "crosswords"],
          photos: [],
          height: "5'9\"",
          bodyType: "average",
        ...
        },
        {
          ...
          bio: "Landscape designer who loves coastal gardens, antique markets, and hosting relaxed dinners for friends.",
          tagline: "Rooted, curious, and still growing",
          lookingFor: "A considerate companion who appreciates nature, design, and close friendships.",
          interests: ["gardening", "antiques", "design", "coastal walks", "hosting"],
          photos: [],
          height: "5'5\"",
          bodyType: "curvy",
        ...
        },
        {
          ...
          bio: "History teacher, jazz listener, and amateur bread baker who likes city walks and thoughtful conversation.",
          tagline: "Learning something new every day",
          lookingFor: "A confident, compassionate person who enjoys ideas, music, and good food.",
          interests: ["history", "jazz", "baking", "walking", "baseball"],
          photos: [],
          height: "6'1\"",
          bodyType: "average",
        ...
        },
        {
          ...
          gender: "woman",
          location: "Phoenix, AZ",
          bio: "Wellness coach and desert hiker who enjoys farmers markets, sunrise yoga, and experimenting with new recipes.",
          tagline: "Finding energy in the everyday",
          lookingFor: "Someone active, optimistic, and ready to build a supportive partnership.",
          interests: ["hiking", "yoga", "farmers markets", "cooking", "wellness"],
          photos: [],
          height: "5'7\"",
          bodyType: "athletic",
        ...
        },
        {
          ...
          bio: "Data analyst, pickup soccer player, and weekend griller who values family, reliability, and plenty of laughter.",
          tagline: "Serious about life, not myself",
          lookingFor: "A genuine partner who enjoys active days, family time, and laughing often.",
          interests: ["soccer", "grilling", "podcasts", "family", "travel"],
          photos: [],
          height: "6'0\"",
          bodyType: "fit",
